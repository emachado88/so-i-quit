...
android/                   # Capacitor Android project (committed; build/ + .gradle/ gitignored)
  ...
  app/src/main/java/com/soiquit/app/MainActivity.java     # registers SystemBarsPlugin (app-local plugins are NOT auto-discovered)
