    ...
    >
      <div class="w-full max-w-sm rounded-2xl bg-surface p-5 shadow-xl">
        <h3 class="text-lg font-bold text-ink">
          {{ t("milestone.exactAlarmTitle") }}
        </h3>
        <p class="mt-1 text-sm leading-relaxed text-muted">
          {{ t("milestone.exactAlarmBody") }}
        </p>
