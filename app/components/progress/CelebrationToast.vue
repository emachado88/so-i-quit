...
<template>
  <Transition name="toast">
    <div
      v-if="message"
      role="status"
      class="fixed bottom-24 left-1/2 z-50 flex w-[calc(100%-2.25rem)] max-w-[400px] -translate-x-1/2 items-center gap-3 rounded-2xl bg-gradient-to-br from-primary to-depth px-4 py-3.5 text-white shadow-lg"
    >
