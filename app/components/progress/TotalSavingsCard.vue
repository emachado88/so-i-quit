...
<template>
  <section
    class="relative overflow-hidden rounded-2xl bg-linear-to-br from-depth via-primary to-primary-hover p-5 text-white shadow-md"
  >
    <div
    ...
    <div class="flex items-center gap-4">
      <div class="min-w-0">
        <p
          class="text-[11px] font-extrabold uppercase tracking-[0.14em] opacity-85"
        >
      ...
      <p
        v-if="sinceDate"
        class="ml-auto text-right text-[11px] font-bold leading-snug opacity-90"
      >
