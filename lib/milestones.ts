...
import type { Habit, Milestone, MilestoneUnit } from "@/constants/types";
 ...
 * Preserves calendar semantics across short months, leap years and
 * anniversaries (e.g. "1 year" is the calendar anniversary, not 365 days).
 */
...
export const ringProgress = (
  ...
  const start = previous
    ? milestoneTargetDate(habit, previous)
    : dayjs(habit.date);
